import { R as React, x as getDefaultExportFromCjs, T as reactExports, K as jsxRuntimeExports } from "./server-CRPQzhcX.js";
...
function Receita() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { title: "Receita", kicker: "Laboratório de sabor", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 pb-20 space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-3xl p-6 md:p-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-end justify-between gap-4 mb-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["Pilsen", "IPA", "Weiss", "Stout"].map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `px-3 py-1.5 rounded-lg text-xs font-semibold border transition ${i === 0 ? "gradient-gold text-[color:var(--navy-deep)] border-transparent" : "border-gold-soft text-gold hover:bg-[color:var(--gold)]/10"}`, children: s }, s)) })
      ] }),
